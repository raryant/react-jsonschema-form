...
- `@mui/material >= 4.2.0` ([in 4.2.0, the `slider` component was added to the core](https://github.com/mui-org/material-ui/pull/16416))
- `@mui/icons-material`
- `@rjsf/core >= 2.0.0`

```bash
yarn add @mui/material @mui/icons-material @rjsf/core
```
